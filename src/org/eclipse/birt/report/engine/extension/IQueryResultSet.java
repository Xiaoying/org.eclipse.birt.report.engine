...
public interface IQueryResultSet extends IBaseResultSet
{
	 ...
	 * -1 represents current row is a detail row. 0 represents the end of whole
	 * resultset
	 * 
	...
	/**
	 * Returns the value of a bound column as the Boolean data type. Currently
	...
	/**
	 * Returns the value of a bound column as the Integer data type. Currently
	 * it is only a dummy implementation.
	 * 
	 * @param name
	 *            of bound column
	...
	/**
	 * Returns the value of a bound column as the Double data type. Currently it
	...
	/**
	 * Returns the value of a bound column as the String data type. Currently it
	 * is only a dummy implementation.
	 * 
	 * @param name
	 *            of bound column
	...
	/**
	 * Returns the value of a bound column as the Date data type. Currently it
	 * is only a dummy implementation.
	 * 
	 * @param name
	 *            of bound column
	...
	/**
	 * Returns the value of a bound column as the Blob data type. Currently it
	 * is only a dummy implementation.
	 * 
	 * @param name
	 *            of bound column
