...
public interface IDrillThroughAction
{
	 ...
	 * This format is used for building the URL when explorer between reports,
	 * running the target report and related process.
	 * 
	 ...
	 * 
	 * @param bookmark
	 *            <code>true</code>, the target element is a bookmark. or
	 *            <code>false</code>, the target element is indicated to be a
	 *            toc.
	 */
	 ...
	 * Get the bookmark.
	 * 
	 * @return the bookmark string if the bookmark type is Bookmark and action
	 *         type is drillthrough. Return <code>null</code> if the bookmark type is TOC and action
	 *         type is drillthrough.
	 */
	String getBookmark( );	
	 ...
	 *            a set of name/value pairs for running the report in a
	 *            drillthrough link.
	 */
	 ...
	 *            a set of name/value pairs for searching the report in a
	 *            drillthrough link.
	 */
