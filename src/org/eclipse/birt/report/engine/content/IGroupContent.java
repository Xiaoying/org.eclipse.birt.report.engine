...
public interface IGroupContent extends IContainerContent
{
	 ...
	 *         <p>
	 *         <code>true</code>, the group header is repeated. <code>false</code>, the group header is
	 *         not repeated.
	 */
	boolean isHeaderRepeat( );

	/**
	 * Set the value if the group header is repeated. if <code>repeat</code>
	 * is true, the group header needs to be repeat. Or, <code>repeat</code>
	 * is false, the group header does not need to be repeat.
	 * 
	 * @param repeat
	 ...
	 * 
	 * @return the header of the group. Return <code>null</code> if the group does not have a
	 *         header.
	 */
	 ...
	 * 
	 * @return the footer of the group. Return <code>null</code> if the group does not have a
	 *         header.
	 */
	...
	/**
	 * Get the level of the group. The default level of the group is
	 * <code>0</code>
	 * 
