...
public class TOCReaderV2 implements ITOCReader, ITOCConstants
{
	...
	public TOCReaderV2( InputStream in, ClassLoader loader, boolean checkVersion )
			throws IOException
	{
	...
	public MemTreeNode readNode( DataInputStream input, ClassLoader loader )
			throws IOException
	{
		MemTreeNode node = new MemTreeNode( );
		String nodeId = IOUtil.readString( input );
		// skip the display string
