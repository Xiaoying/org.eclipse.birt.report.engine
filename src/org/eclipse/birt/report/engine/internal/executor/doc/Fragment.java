...
public class Fragment
{
	...
	/**
	 * @deprecated
	 * backward for 2.1.0 document.
	 * This method can only insert a fragment of given offset as a child of current fragment.
	 */
	 ...
	 * 
	 * @param left
	 *            the left edge which is going to be inserted.
	 * @param right
	 *            the right edge which is going to be inserted.
	 ...
	 * 
	 * @param parent
	 *            the inserted or founded edge node.
	 * @param node
	 *            node to be insert.
	...
	private Fragment addFragment( Fragment parent, Object offset )
	{
		...
		else
		{
			...
			throw new RuntimeException(
					"Wrong offset found while building fragment tree" );
		}
	}
