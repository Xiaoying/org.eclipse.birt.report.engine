...
public class EngineIRTransferV221 extends DesignVisitor
{
	...
	protected static Logger logger = Logger
			.getLogger( EngineIRTransferV221.class.getName( ) );
	...
	{
		apply( handle );
		report.setVersion( ReportDocumentConstants.BIRT_ENGINE_VERSION_2_2_1 );
	}
	...
	{
		// get ListItem
		ListItemDesign listItem = (ListItemDesign) report
				.getReportItemByID( handle.getID( ) );
	...
	{
		// get Table Item
		TableItemDesign table = (TableItemDesign) report
				.getReportItemByID( handle.getID( ) );
	...
	{
		ListGroupDesign listGroup = (ListGroupDesign) report
				.getReportItemByID( handle.getID( ) );
	...
	{
		TableGroupDesign tableGroup = (TableGroupDesign) report
				.getReportItemByID( handle.getID( ) );
