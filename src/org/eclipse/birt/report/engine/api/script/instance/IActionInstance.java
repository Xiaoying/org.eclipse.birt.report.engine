...
public interface IActionInstance
{
	...
	/**
	 * @return the bookmark string when action type is bookmark.
	...
	/**
	 * Set bookmark.
	 * And set the type be org.eclipse.birt.report.engine.content.IHyperlinkAction.ACTION_BOOKMARK
	 * Throw IllegalArgumentException if the bookmark be set to null.
	 * @param bookmark
	 */
	void setBookmark( String bookmark );

	/**
	 * @return the action string when action type is hyperlink.
	 * Otherwise, throw RuntimeException.
	 */
	String getHyperlink( );
	 ...
	 * And set the type be org.eclipse.birt.report.engine.content.IHyperlinkAction.ACTION_HYPERLINK
	...
	/**
	 * @return The name of a frame where a target hyperlink or drillThrough to be opened.
	 */
	...
	/**
	 * @return the drillThrouthInstance when action type is drillThrough.
	 * Otherwise, throw RuntimeException.
	 */
	 ...
	 * And set the type be org.eclipse.birt.report.engine.content.IHyperlinkAction.ACTION_DRILLTHROUGH
