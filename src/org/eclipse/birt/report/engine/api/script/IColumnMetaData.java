...
public interface IColumnMetaData {
	 ...
	 * column as a programmatic convenience. A column can be referred using a
	 * name or an alias interchangeably.
	 * 
	 * @param index
	 *            The projected column index.
	 ...
	 * column. A computed column is one that is not retrieved from the
	 * underlying data provider. Only those computed columns declared explicitly
	 * in a data set design are considered as "computed" columns.
	 * 
	 * @param index
	 *            The projected column index.
