...
public class BorderWidthManager extends AbstractLengthManager
{
	...
	static
	{
		...
		values
				.put( CSSConstants.CSS_THICK_VALUE,
	...
	static
	{
		computedValues.put( CSSConstants.CSS_THIN_VALUE, new FloatValue(
				CSSPrimitiveValue.CSS_PX, 1 ) );
		computedValues.put( CSSConstants.CSS_MEDIUM_VALUE, new FloatValue(
				CSSPrimitiveValue.CSS_PX, 3 ) );
		computedValues.put( CSSConstants.CSS_THICK_VALUE, new FloatValue(
