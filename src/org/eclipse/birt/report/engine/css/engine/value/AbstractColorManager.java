...
public abstract class AbstractColorManager extends IdentifierManager
{
	...
	public static void addColorIndent( StringMap values )
	{
		...
		values
				.put( CSSConstants.CSS_BLACK_VALUE,
						CSSValueConstants.BLACK_VALUE );
		...
		values.put( CSSConstants.CSS_WINDOW_VALUE,
				CSSValueConstants.WINDOW_VALUE );
	 ...
	 */
	protected Value createRGBColor( CSSPrimitiveValue r, CSSPrimitiveValue g,
			CSSPrimitiveValue b )
	{
